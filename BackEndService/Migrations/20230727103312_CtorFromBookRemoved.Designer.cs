...
namespace BackEndService.Migrations
{
    ...
    [Migration("20230727103312_CtorFromBookRemoved")]
    partial class CtorFromBookRemoved
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEndService.Models.BookStudent", b =>
                {
                    b.HasOne("BackEndService.Models.Book", "Book")
                        .WithMany("BookStudents")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackEndService.Models.Student", "Student")
                        .WithMany("BookStudents")
